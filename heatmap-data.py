...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--all", type = str, help = "Generate Heat Map of All VAF Ranges")
    parser.add_argument("-l", "--lfv", type = str, help = "Generate Heat Map of Low Frequency VAF Ranges")
    ...
    # Some Basic Input Resolution
    if allRanges is None and lfvRanges is None:
    ...
    for dataset in metadata["datasets"]:
        for condition in metadata["conditions"]:
            ...
            for vafrange in metadata["lfvranges"]:
    ...
    ax.set_xticklabels(["%s - %s" % tup for tup in metadata["lfvranges"]], minor = False, fontsize = 6)
    ...
    for t in ax.yaxis.get_major_ticks():
        t.tick1On = False
        t.tick2On = False
    fig.savefig("output/heatmap.pdf")
    plt.show()
